<template>
  <div class=" text-center">
    ...
    <div class="max-w-[760px] text-lg text-left mx-auto mt-12 md:space-y-10 space-y-16">
      <img src="covers/home-cover.png" class=" w-full" />
      <!-- Section 1 -->
      ...
      <div class="flex flex-col md:flex-row items-center space-y-3 md:space-x-12">
          <div class="w-full md:w-1/2">
            <img src="illustrations/illustration-2.png" alt="">
          </div>
          <div class="w-full md:w-1/2">
            <h2 class="h2">How Can I Join?</h2>
            <p class="p">Become Part of Our Community: Joining is easy! Simply start as a "Contributor" by locking in 1 ICP, or apply as a "Volunteer" to actively engage in on-site activities. Whether you’re helping to build the site or fund its growth, your role is vital.</p>
          </div>
      </div>
      ...
      <div class="flex flex-col md:flex-row-reverse items-center space-y-3 md:space-x-reverse md:space-x-12">
          <div class="w-full md:w-1/2">
            <img src="illustrations/illustration-1.png" alt="">
          </div>
          <div class="w-full md:w-1/2">
