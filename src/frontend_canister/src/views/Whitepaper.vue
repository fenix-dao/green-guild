<template>
  <div class="max-w-[760px] text-lg text-left mx-auto md:space-y-10 space-y-16">
    <div v-html="whitepaperContent" class="md"></div>
  </div>
</template>
